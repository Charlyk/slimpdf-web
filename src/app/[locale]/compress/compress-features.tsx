import { Zap, Shield, Target, Clock, Lock, Gift } from "lucide-react"
import { getTranslations } from "next-intl/server"

import { Card, CardContent } from "@/components/ui/card"

const featureItems = [
  { key: "ghostscript", icon: Zap },
  { key: "quality", icon: Shield },
  { key: "targetSize", icon: Target },
  { key: "fast", icon: Clock },
  { key: "secure", icon: Lock },
  { key: "free", icon: Gift },
]

export async function CompressFeatures() {
  const t = await getTranslations("compress.features")
