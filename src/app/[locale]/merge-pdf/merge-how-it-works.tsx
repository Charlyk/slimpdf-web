import { Upload, ArrowUpDown, Download } from "lucide-react"
...
const steps = [
  ...
  { key: "arrange", icon: ArrowUpDown },
  { key: "download", icon: Download },
]

export async function MergeHowItWorks() {
  const t = await getTranslations("merge.howItWorks")
