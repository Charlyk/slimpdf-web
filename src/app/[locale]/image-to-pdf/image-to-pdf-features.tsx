import { Images, FileText, Shield, GripVertical, Lock, Gift } from "lucide-react"
import { getTranslations } from "next-intl/server"

import { Card, CardContent } from "@/components/ui/card"

const featureItems = [
  { key: "multipleImages", icon: Images },
  { key: "pageSize", icon: FileText },
...
export async function ImageToPdfFeatures() {
  const t = await getTranslations("imageToPdf.features")
